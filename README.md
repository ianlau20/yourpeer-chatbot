...
| [TESTING.md](docs/TESTING.md) | Test suite guide — 1,475 tests across 39 files in `unit/` and `integration/` directories + 142-scenario LLM-as-judge evaluation framework |
