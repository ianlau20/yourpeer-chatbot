...
def query_services(
    ...
    if location:
        ...
        # Expand borough to all neighborhood-level city values.
        # "Queens" → ["astoria", "far rockaway", "flushing", ..., "queens"]
        # This catches locations stored under neighborhood names in the DB.
