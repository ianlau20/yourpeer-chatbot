...
- **Tone-aware service responses** — when a user expresses emotion alongside a service request, the confirmation and follow-up messages include an empathetic prefix: emotional → "I hear you, and I want to help.", frustrated → "I understand this has been frustrating.", confused → "No worries — let me help you with that."
